...
import org.example.orders.SaleOrder;
import org.example.products.CompositeProduct;
import org.example.products.SimpleProduct;
...
public class App 
{
    ...
    private void orderSimpleProducts() {
        ...
        SaleOrder simpleProductOrder = new SaleOrder(random.nextInt(), "Pack Bookers");
    ...
    private void orderBig() {
        SaleOrder customOrder = new SaleOrder(4, "Geo Turner");
